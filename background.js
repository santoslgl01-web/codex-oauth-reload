...
const runtimeUpdateManager = self.MultiPageRuntimeUpdate?.createRuntimeUpdateManager?.({
  chrome,
  setTimeout,
  clearTimeout,
});
...
const DEFAULT_CLASH_BRIDGE_CONTROLLER_URL = self.MultiPageBackgroundClashBridge?.DEFAULT_CONTROLLER_URL || 'http://127.0.0.1:62754';
const DEFAULT_CLASH_BRIDGE_PROXY_GROUP = self.MultiPageBackgroundClashBridge?.DEFAULT_PROXY_GROUP || 'NODE-SELECT';
