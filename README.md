...
<a href="https://www.star-history.com/?repos=santoslgl01-web%2Fcodex-oauth-reload&type=timeline&logscale&legend=top-left">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=santoslgl01-web/codex-oauth-reload&type=timeline&logscale&theme=dark&legend=top-left" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=santoslgl01-web/codex-oauth-reload&type=timeline&logscale&legend=top-left" />
    <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=santoslgl01-web/codex-oauth-reload&type=timeline&logscale&legend=top-left" />
  </picture>
</a>
...
- 侧边栏会检查 GitHub Releases；发现新版本后，更新卡片会显示“一键更新”。
- 如果当前扩展是带 `update_url` 的 CRX 安装版，点击“一键更新”会调用浏览器扩展更新通道，检测到新包后自动重载扩展并应用新版，不需要先移除扩展、再重新加载目录。
- 如果当前是开发者模式“加载已解压的扩展程序”，浏览器不能自动替换本地目录；按钮会退回到打开 GitHub Release，需手动下载新版。
